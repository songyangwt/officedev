...
public class UschViewLzz {
	private static final Log log = LogFactory.getLog(UschViewLzz.class);
	private String newnumber;
	private String type;//lzz/ycb/ybj
	...
	*/
	...
	public String execute() throws Exception
	{
		...
		try {
			...
			hql = "from UassCostHn as up where substr(up.initiator,1,8)='"+newnumber1+"' and up.status in (1,2,5) order by up.id desc";
