...
public class UscwViewUnder {
	private static final Log log = LogFactory.getLog(UscwViewUnder.class);
	...
	*/
	...
	public String execute() throws Exception
	{
		...
		try {
			...
			hql = "from UassCostWb as uc where substr(uc.undertake,1,8)='"+newnumber1+"' or (substr(uc.initiator,1,8)='"+newnumber1+"' and uc.status in (0,5)) order by uc.id desc";
