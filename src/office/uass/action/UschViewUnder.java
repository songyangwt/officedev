...
public class UschViewUnder {
	private static final Log log = LogFactory.getLog(UsptViewUnder.class);
	...
	*/
	...
	public String execute() throws Exception
	{
		...
		try {
			...
			hql = "from UassCostHn as up where substr(up.undertake,1,8)='"+newnumber1+"' or (substr(up.initiator,1,8)='"+newnumber1+"' and up.status in (0,5)) order by up.id desc";
