	...
	*/
	...
	public String execute() throws Exception
	{
		...
		try {
			...
			hql = "from UassJihe as uc where substr(uc.undertake,1,8)='"+newnumber1+"' or (substr(uc.initiator,1,8)='"+newnumber1+"' and uc.status in (0,5)) order by uc.id desc";
