...
public class UsjhSubPage {
	...
	public String execute() throws Exception {
		String realpath = Util.jihepath;
		UassJihe uc = new UassJihe();
		...
		// 职务0主任1处长2团队负责人3小组长4普通员工
			index = "000"+fraw.readandwrite("USJH");
			index = index.substring(index.length() - 3, index.length());
			number = date + "USJH" + dai + bu + index;
