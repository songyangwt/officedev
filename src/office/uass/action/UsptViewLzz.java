...
public class UsptViewLzz {
	private static final Log log = LogFactory.getLog(UsptViewLzz.class);
	...
	*/
	...
	public String execute() throws Exception
	{
		...
		try {
			...
			hql = "from UassPt as up where substr(up.initiator,1,8)='"+newnumber1+"' and up.status in (1,2,5) order by up.id desc";
