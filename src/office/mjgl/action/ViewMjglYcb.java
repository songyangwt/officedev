...
public class ViewMjglYcb {
	...
	*/
	...
	public String execute() throws Exception
	{
		...
		try {
			hql = "from TMjgl as tm where tm.number in (select number from LeaveProcess as lproc where lproc.viewernewnumber='"+newnumber+"') and tm.status in (1,2,3,10) order by tm.id desc";
