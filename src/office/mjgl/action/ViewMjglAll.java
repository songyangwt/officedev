...
public class ViewMjglAll {
	...
	*/
	...
	public List<TMjgl> getList() {
		return list;
	}

	public void setList(List<TMjgl> list) {
		this.list = list;
	}
	...
	public String execute() throws Exception
	{
		...
		try {
			...
			hql +=" where tm.initiator like '%"+un+"%'";
			...
			if(zxtd!=null&&zxtd.equals("td"))
			{
				...
				else if(chutuan>=7&&chutuan<=9)
				{
					...
					hql += " and tm.chu='3' and tm.zu='"+temptuan+"'";
				}
				else if(chutuan>=10&&chutuan<=12)
				{
					int temptuan = chutuan-9;
					hql += " and tm.chu='6' and tm.zu='"+temptuan+"'";
				}
				if(zhi.equals("0")||zhi.equals("1")||autho.contains("Q")||autho.contains("I"))//主任看全部
				{
					hql += "";
				}
