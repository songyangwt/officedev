...
import office.jbsp.pojo.JbspPageDiBean;
...
public class ViewJbspAll {
	...
	*/
	...
	public List<JbspPageDiBean> getList() {
		return list;
	}

	public void setList(List<JbspPageDiBean> list) {
		this.list = list;
	}
	...
	public String execute() throws Exception
	{
		...
		list = new ArrayList<JbspPageDiBean>();
		List<JbspPage> listjp = new ArrayList<JbspPage>();
		Query query;
		String hql = "";
		String position = "";
		String zhi = "";
		...
		try {
			...
			hql = "from JbspPage as jp where 1=1";
...
//			}
			...
			for(int i=0;i<listjp.size();i++)
			{
				...
				{
					JbspPageDiBean dpdb = new JbspPageDiBean();
					JbspPageDi jpdtemp = jpddao.findAllByNumberName(jp.getNumber(),people[j]);
