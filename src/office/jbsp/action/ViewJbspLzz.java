...
public class ViewJbspLzz {
	...
	public String execute() throws Exception
	{
		...
		try {
			...
			hql = "from JbspPage as jp where (substr(jp.initiator,1,8)='"+newnumber1+"' or jp.number in (select number from JbspPageDi as jpd where jpd.name='"+strtemp+"')) and jp.status in (1,2,3,5) order by jp.id desc";
