...
public class StAdd {
	...
	public String execute() throws Exception
	{
    	...
    	List listst = stdao.findAllOrderByNo(num);
...
//			}
    	...
    	try {
    		...
    		for(int i=0;i<members.split("、").length;i++)
    		{
        		...
        		else if(uidao.findChuByName(tempname)==4||uidao.findChuByName(tempname)==5)
        		{
