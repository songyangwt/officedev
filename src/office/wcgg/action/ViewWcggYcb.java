	...
	*/
	...
	public String execute() throws Exception
	{
		...
		try {
			...
			hql = "from WcggPage as wp where wp.number in (select number from LeaveProcess as lproc where lproc.viewernewnumber='"+newnumber+"') and wp.status in (1,2,3,4) order by wp.id desc";
