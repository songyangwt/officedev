	...
	*/
	...
	public String execute() throws Exception
	{
		...
		try {
			...
			hql = "from WcggPage as wp where substr(wp.thisunder,1,8)='"+newnumber1+"' or (substr(wp.initiator,1,8)='"+newnumber1+"' and wp.status in (0,5)) or (wp.people like '%"+ui.getUsername()+"%' and wp.status=3) order by wp.id desc";
