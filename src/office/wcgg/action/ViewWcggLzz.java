...
public class ViewWcggLzz {
	...
	*/
	...
	public List<WcggPage> getList() {
		return list;
	}

	public void setList(List<WcggPage> list) {
		this.list = list;
	}
	...
	public String execute() throws Exception
	{
		...
		try {
			...
			hql = "from WcggPage as wp where (substr(wp.initiator,1,8)='"+newnumber1+"' or wp.number in (select number from WcggBaodao as wb where substr(wb.newnumber,1,8)='"+newnumber1+"') )and wp.status in (1,2,3,5) order by wp.id desc";
