	...
	*/
	...
	public String execute() throws Exception
	{
		...
		try {
			...
			hql = "from XxsqPage as xp where (substr(xp.initiator,1,8)='"+newnumber1+"' or xp.people like '%"+strtemp+"%') and xp.status in (1,2,5) order by xp.id desc";
