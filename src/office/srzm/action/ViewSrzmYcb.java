...
public class ViewSrzmYcb {
	...
	*/
	...
	public String execute() throws Exception
	{
		...
		try {
			hql = "from TSrzm as tz where tz.number in (select number from LeaveProcess as lproc where lproc.viewernewnumber='"+newnumber+"') and tz.status in (1,2,3,4,7) order by tz.id desc";
