...
public class ViewYcb {
	...
	*/
	...
	public String execute() throws Exception
	{
		...
		String hql = "";
		title = "已承办";
		hql = "from LeavePage as lp where lp.number in (select number from LeaveProcess as lproc where lproc.viewernewnumber='"+newnumber+"') and lp.status in (1,2,6,7,8,9) order by lp.id desc";
