...
public class ShowZzzmPageDfAjax {
	...
	public boolean ifcandai(String autho,String positionfq,String positionsq)
	{
		...
		//String authoJ = autho.substring(9,10);
		//String authoI = autho.substring(8,9);
		//String authoG = autho.substring(6,7);
		//String authoH = autho.substring(7,8);
