	...
	*/
	...
	public String execute() throws Exception
	{
		...
		try {
			...
			hql = "from TZzzm as tz where (substr(tz.applicant,1,8)='"+newnumber1+"' or substr(tz.initiator,1,8)='"+newnumber1+"') and tz.status in (1,2,3,5) order by tz.id desc";
