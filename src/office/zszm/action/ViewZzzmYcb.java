...
public class ViewZzzmYcb {
	...
	*/
	...
	public List<TZzzm> getList() {
		return list;
	}

	public void setList(List<TZzzm> list) {
		this.list = list;
	}
	...
	public String execute() throws Exception
	{
		...
		try {
			hql = "from TZzzm as tz where tz.number in (select number from LeaveProcess as lproc where lproc.viewernewnumber='"+newnumber+"') and tz.status in (1,2,3,4) order by tz.id desc";
