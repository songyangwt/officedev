	...
	*/
	...
	public String execute() throws Exception
	{
		...
		try {
			...
			hql = "from TYscj as ty where (substr(ty.applicant,1,8)='"+newnumber1+"' or substr(ty.initiator,1,8)='"+newnumber1+"' )and ty.status in (1,2,3,5,8,9) order by ty.id desc";
