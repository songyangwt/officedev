	...
	*/
	...
	public String execute() throws Exception
	{
		...
		try {
			...
			hql = "from TYscj as ty where ty.number in (select number from LeaveProcess as lproc where lproc.viewernewnumber='"+newnumber+"') and ty.status in (1,2,3,4) order by ty.id desc";
