...
public class DeleteYscjPage {
	...
	public String execute() throws Exception
	{
		...
		TYscjtz tz = tzdao.findAllByNumber(number);
		...
		if(ty.getStatus()==3||ty.getStatus()==4)//如果状态已审批完毕，需反向执行提交操作
		{
			//message = tydao.unSubmitWcggPage(number);
		}
