...
public class ViewYscjTz {
	private static final Log log = LogFactory.getLog(TYscjtz.class);
	private String newnumber;// 新一代员工编号
	private List<TYscjtz> list;
	...
	*/
	...
	public List<TYscjtz> getList() {
		return list;
	}

	public void setList(List<TYscjtz> list) {
		this.list = list;
	}
	...
	public String execute() throws Exception
	{
		...
		try {
			...
			hql = "from TYscjtz as tz where tz.status!=6";
			if(name!=null)
			{
				//strtemp = new String(name.getBytes("ISO8859-1"),"UTF-8");
				hql +=" and tz.name like '%"+name+"%'";
			}
			/*else
			{
				strtemp = name;
