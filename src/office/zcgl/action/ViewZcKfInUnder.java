...
public class ViewZcKfInUnder {
	...
	*/
	...
	public List<StorehouseIn> getList() {
		return list;
	}

	public void setList(List<StorehouseIn> list) {
		this.list = list;
	}
	...
	public String execute() throws Exception
	{
		...
		try {
			...
			hql= "from StorehouseIn as ah where substr(ah.thisunder,1,8)='"+newnumber+"' or (substr(ah.initiator,1,8)='"+newnumber+"' and ah.status in (0,5)) order by ah.id desc";
