	...
	*/
	...
	public String execute() throws Exception
	{
		...
		try {
			...
			hql= "from StorehouseOut as ah where substr(ah.thisunder,1,8)='"+newnumber+"' or (substr(ah.initiator,1,8)='"+newnumber+"' and ah.status in (0,5)) order by ah.id desc";
