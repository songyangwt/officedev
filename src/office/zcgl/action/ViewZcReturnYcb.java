...
public class ViewZcReturnYcb {
	...
	*/
	...
	public String execute() throws Exception
	{
		...
		try {
			hql = "from AssetReturn as ay where ay.number in (select number from LeaveProcess as lproc where lproc.viewernewnumber='"+newnumber+"') and ay.status !=4 order by ay.id desc";
