...
public class SubZcBorrowPage {
	...
	{
		AssetBorrow ay = new AssetBorrow();
...
//		} else {
			...
			index = "000"+fraw.readandwrite("ZCJY");
			index = index.substring(index.length() - 3, index.length());
			number = date + "ZCJY" + index;
//		}
		//是否表中有重复项
        ...
        ay.setReturntime(returntime);
        ay.setIsreturn(0);
        ay.setIsandborrow(0);
        ay.setAndborrowreturntime("");
