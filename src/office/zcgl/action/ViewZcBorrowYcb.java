...
public class ViewZcBorrowYcb {
	...
	*/
	...
	public String execute() throws Exception
	{
		...
		try {
			hql = "from AssetBorrow as ay where ay.number in (select number from LeaveProcess as lproc where lproc.viewernewnumber='"+newnumber+"') and ay.status !=4 order by ay.id desc";
