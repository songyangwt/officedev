	...
	*/
	...
	public String execute() throws Exception
	{
		...
		try {
			...
			//hql1="from AssetApply as ay where ay.status=14 and ay.initiator!='"+newnumber+"' order by ay.id desc";
			hql2= "from AssetApply as ay where substr(ay.thisunder,1,8)='"+newnumber1+"' or (substr(ay.initiator,1,8)='"+newnumber1+"' and ay.status in (0,5)) order by ay.id desc";
