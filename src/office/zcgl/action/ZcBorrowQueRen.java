...
public class ZcBorrowQueRen {
	...
	public void changeassetinfo(List<AssertFen> listaf,AssetBorrow ay)
	{
		...
		for(int i=0;i<listaf.size();i++)
		{
			...
			ai.setReturntime(ay.getReturntime());
	...
	public void unchangeassetinfo(List<AssertFen> listaf,AssetBorrow ay)
	{
		AssetInfoDAO aidao=new AssetInfoDAO();
		for(int i=0;i<listaf.size();i++)
		{
	...
	public int checksamechu(AssetBorrow ay ,List<AssertFen> listaf,UserInfoDAO uidao)
	{
		int flag=1;
		int chu = ay.getChu();
		String name="";
