...
public class ViewZcApplyAll {
	...
	*/
	...
	public List<AssetApply> getList() {
		return list;
	}

	public void setList(List<AssetApply> list) {
		this.list = list;
	}
