...
/**
 * AbstractTZbspPage entity provides the base persistence definition of the
 * TZbspPage entity. @author MyEclipse Persistence Tools
 */

public abstract class AbstractTZbspPage implements java.io.Serializable {
	...
	/** default constructor */
	public AbstractTZbspPage() {
	}

	/** full constructor */
	public AbstractTZbspPage(String number, Integer process, String jindu,
