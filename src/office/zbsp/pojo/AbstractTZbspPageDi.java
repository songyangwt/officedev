...
/**
 * AbstractTZbspPageDi entity provides the base persistence definition of the
 * TZbspPageDi entity. @author MyEclipse Persistence Tools
 */

public abstract class AbstractTZbspPageDi implements java.io.Serializable {
	...
	/** default constructor */
	public AbstractTZbspPageDi() {
	}

	/** full constructor */
	public AbstractTZbspPageDi(String number, String name, String begindate,
