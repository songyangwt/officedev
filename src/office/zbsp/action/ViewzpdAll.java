...
public class ViewzpdAll {
	...
	public List<TZbspPageDi> getList() {
		return list;
	}

	public void setList(List<TZbspPageDi> list) {
		this.list = list;
	}
	...
	public String execute() throws Exception
	{
		...
		try {
			...
			hql = "from TZbspPageDi as jpd where 1=1";
