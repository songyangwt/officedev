...
public class ViewzbspUnder {
	...
	public String execute() throws Exception
	{
		...
		try {
			...
			hql = "from TZbspPage as jb where substr(jb.thisunder,1,8)='"+newnumber1+"' or (substr(jb.initiator,1,8)='"+newnumber1+"' and jb.status in (0,5)) order by jb.id desc";
