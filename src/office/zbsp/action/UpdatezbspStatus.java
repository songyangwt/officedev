...
public class UpdatezbspStatus {
	...
	public String execute() throws Exception
	{
		...
		if(status==4)
		{
			jpdao.unsubmitzbspPage(number,session);
			jp.setStatus(1);
		}
		else if(status==1)
		{
...
//	{
//		zbspPageDAO jpdao = new zbspPageDAO();
//		LeaveProcessDAO lpdao = new LeaveProcessDAO();
//		List<zbspPage> list = jpdao.findAll();
//		for(int i=0;i<list.size();i++)
//		{
//			zbspPage jp= list.get(i);
