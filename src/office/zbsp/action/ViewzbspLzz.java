...
public class ViewzbspLzz {
	...
	public List<TZbspPage> getList() {
		return list;
	}
	public void setList(List<TZbspPage> list) {
		this.list = list;
	}
	...
	public String execute() throws Exception
	{
		...
		try {
			...
			hql = "from TZbspPage as jp where (substr(jp.initiator,1,8)='"+newnumber1+"' or jp.number in (select number from TZbspPageDi as jpd where jpd.name='"+strtemp+"')) and jp.status in (1,2,3,5) order by jp.id desc";
