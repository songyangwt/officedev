...
public class ViewzbspSummary {

	private static final Log log = LogFactory.getLog(ViewzbspSummary.class);
	private List<TZbspSummary> list;
	private String name;
	...
	public List<TZbspSummary> getList() {
		return list;
	}
	public void setList(List<TZbspSummary> list) {
		this.list = list;
	}
	...
	public String execute() throws Exception
	{
		...
		String sql = "select distinct year from t_zbsp_summary";
		String hql = "from TZbspSummary as js where js.year="+year;
	
		String hql2 = "from TZbspSummary as js where js.name='"+LeaveUtil.NewNumberToName(newnumber)+"' order by js.year desc";
