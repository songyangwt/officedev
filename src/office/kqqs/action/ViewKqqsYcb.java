...
public class ViewKqqsYcb {
	...
	*/
	...
	public String execute() throws Exception
	{
		...
		try {
			hql = "from KqqsPage as kp where kp.number in (select number from LeaveProcess as lproc where lproc.viewernewnumber='"+newnumber+"') and kp.status in (1,2,3,4) order by kp.id desc";
