	...
	*/
	...
	public String execute() throws Exception
	{
		...
		try {
			...
			hql = "from KqqsPage as kp where (substr(kp.initiator,1,8)='"+newnumber1+"' or substr(kp.applicant,1,8)='"+newnumber1+"') and kp.status in (1,2,5) order by kp.id desc";
