...
<html>
  ...
  function download(f)
	 {
		 window.open("<%=path%>/page/uass/derivejihe.jsp?Path="+f,"","height=70,width=300,top=400,left=600"); 
	 }
  function tijiao() {
  ...
  <body>
    <form action="usjhshenpi.action" method="post">
