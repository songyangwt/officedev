					...
					<table style="width:600px" height="80" align="center" cellpadding="0"
						...
						<tr class="qq">
							...
							按关键字排序<select id="keyword" name="keyword" style="width: 70px" >
								<option value="times">值班次数</option>
								<option value="days">值班天数</option>
						...
						<tr height="50px" class="表格表头背景1" id="hang">
							...
							<td colspan="7">
								<div align="center">
								<a	href="<%=path%>/viewzbspsummary.action?newnumber=${newnumber}&zhuan=1&year=${year}&zxtd=td&chutuan=${chutuan}&name=${name}&keyword=${keyword}&currentPage=${previousPage}"
							style="padding-right: 30px;color: #104E8B">上一页</a> 
									${currentPage} of ${totalPages}
								<a	href="<%=path%>/viewzbspsummary.action?newnumber=${newnumber}&zhuan=1&year=${year}&zxtd=td&chutuan=${chutuan}&name=${name}&keyword=${keyword}&currentPage=${nextPage}"
