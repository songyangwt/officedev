...
<html>
  ...
  ${daohang}
    ...
    <p align="center" style="padding:0px;margin:0px; font-size: 24px;"><strong><c:if test="${bu=='1'}"><font style="color:red;">（补）</font></c:if>业务处理中心值班审批备案表</strong><strong> </strong></p>
