...
<html>
	...
	<body>
		<form action="<%=path%>/ptmodify.action" method="post">
			<div class="layout">
				<div class="title">
					特殊人员修改（<b style="color:red">*</b>为必填项）
				</div>
				...
				<div class="four_columns">
						...
						<div>
						 	<input size=10 type="text" name="begindate" id="begindate" value="${begindate}" class="Wdate" onClick="WdatePicker()" >
						</div>
					<div class="clear"></div>
				</div>
				<div class="four_columns">
						...
						<div>
						 	<input size=10 type="text" name="enddate" id="enddate" value="${enddate}" class="Wdate" onClick="WdatePicker()" >
						</div>
					<div class="clear"></div>
				</div>
				<div class="button">
