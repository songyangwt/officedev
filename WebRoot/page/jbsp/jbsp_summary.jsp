					...
					<table style="width:600px" height="80" align="center" cellpadding="0"
						...
						<tr>
							<td
								...
								colspan="6" align="center" bordercolor="#FFFFFF"><b>加班审批-个人汇总</b>
							</td>
						</tr>
						<tr height="50px" class="表格表头背景1" id="hang">
							...
							<td colspan="6">
								<div align="center">
								<a	href="<%=path%>/viewjbspsummary.action?newnumber=${newnumber}&zhuan=1&year=${year}&name=${name}&keyword=${keyword}&currentPage=${previousPage}"
							style="padding-right: 30px;color: #104E8B">上一页</a> 
									${currentPage} of ${totalPages}
								<a	href="<%=path%>/viewjbspsummary.action?newnumber=${newnumber}&zhuan=1&year=${year}&name=${name}&keyword=${keyword}&currentPage=${nextPage}"
