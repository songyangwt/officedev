		...
		if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
			yesorno=xmlhttp.responseText;
				...
				if(arr[0].length==5)
				{
					...
					document.getElementById("passport").innerHTML=arr[3];
					document.getElementById("username").innerHTML=arr[4]+arr[5];
			
					document.getElementById("zxdate").innerHTML=arr[6];
					document.getElementById("sex").value=arr[7];
					
		}				
	} 
	xmlhttp.open("GET","showzzzmpagedfajax.action?name="+name+"&newnumber="+newnumber,true);
	xmlhttp.send();
}
    ...
    <form action="subzzzmpage.action" method="post">
        ...
        <table width="945" height="398" border="1" align="center" cellpadding="1" cellspacing="0">
    		...
    		<td width="121" class="as">
    			...
    			<td width="201">
    				<div align="center" id="passport">&nbsp;</div>
    			</td>
    		</tr>
    		<tr>
    			<td  class="as">
    		...
    		<tr>
    			...
    			<td colspan="3">
    			<input type="text" name="yongtu" style="width:450px"/><br>（请详细填写开具用途，如需办理签注需具体填写国家和日期）
    			</td>
    			<td class="as">
    				所需份数<b>*</b>
    			</td>
