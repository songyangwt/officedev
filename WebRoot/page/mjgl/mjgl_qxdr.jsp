...
<body>
	<div style="color: #1778C2; padding-top: 0px; padding-bottom: 5px; border: 0px; font-size: 26px; font-family: '黑体';"
			colspan="14" align="center" bordercolor="#FFFFFF"><b>门禁权限表导入</b>
	</div>
	<div class="layout">
		<form name="filename" method="post" action="importmjglpage.action"
			enctype="multipart/form-data">
			<div class="title" ><b>门禁权限表导入,选择上传文件</b></div>
			<div id="content" >
				<div class="four_columns">
					...
					<div class="four_columns_input">
						...
						<br/>
					<div class="four_columns_input" >
						<a href="<%=path%>/templet/menjin.xls">下载【门禁权限表】模板</a>
					</div>
				</div>
			</div>
		</form>
