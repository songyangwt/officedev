  ...
  <form action="<%=path%>/viewsrzmall.action" method="post" name="fm1">
					<table height="80" align="center" cellpadding="0"
						...
						<tr>
							...
							<td colspan="14">
								<div align="center">
								<a	href="<%=path%>/viewsrzmall.action?zhuan=1&begindate=${begindate}&enddate=${enddate}&chutuan=${chutuan}&name=${strtemp}&newnumber=${newnumber}&currentPage=${previousPage}"
							style="padding-right: 30px;color: #104E8B">上一页</a> 
									${currentPage} of ${totalPages}
								<a	href="<%=path%>/viewsrzmall.action?zhuan=1&begindate=${begindate}&enddate=${enddate}&chutuan=${chutuan}&name=${strtemp}&newnumber=${newnumber}&currentPage=${nextPage}"
