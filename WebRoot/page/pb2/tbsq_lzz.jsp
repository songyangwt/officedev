					...
					<table height="80" align="center" cellpadding="0"
						...
						<tr height="50px" class="表格表头背景1" id="hang">
							...
							<tr class="btbj" id="hang" style="height:20px">
								...
								<td height="25" align="center" valign="middle" ><div
										align="center">
										<c:if test="${(newnumber==tp.initiator)&&(tp.status==1)}">
							...
							<td colspan="14">
								<div align="center">
								<a	href="<%=path%>/tbsqlzz.action?newnumber=${newnumber}&currentPage=${previousPage}"
							style="padding-right: 30px;color: #104E8B">上一页</a> 
									${currentPage} of ${totalPages}
								<a	href="<%=path%>/tbsqlzz.action?newnumber=${newnumber}&currentPage=${nextPage}"
