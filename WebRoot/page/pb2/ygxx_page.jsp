	...
	////////提交计算前检查一下///////////////////////////
	 ...
	 function tijiao() {
		 ...
		 // var panduan= sumdate.selectedIndex;
		  ...
		  else if(Number(days*6)<Number(day*6+hour))
			{
        ...
        <table width="860" height="398" border="1" align="center" cellpadding="1" cellspacing="0">
    		...
    		<tr>
    			<td class="as">
    			 ...
    			 <td colspan="5" >
     				<div style="float:left;padding-top:8px;width:110px">从<input size="9" type="text" name="begindate" id="begindate" class="Wdate" onClick="WdatePicker();istip()" ></div>
    				 ...
    				 <div style="float:left;padding-top:8px;width:120px"> 起至<input size="9" type="text" name="enddate" id="enddate" class="Wdate" onClick="WdatePicker();istip()" ></div>      
    				 <div style="float:left">      
     				...
     				<div style="float:left;padding-top:8px;">止，共<input size="2" style="IME-MODE: disable;" maxlength="5" type="text" name="day" id="day" >天
      			 	<input size="2" style="IME-MODE: disable;" maxlength="5" type="text" name="hour" id="hour" >小时 </div><b>跨季度请分两次填写</b>
        		</td>
    		</tr>
    		<tr>
    			<td class="as">
    			...
    			<td colspan="5">
    				...
    				<input size="36" type="text" name="qita" id="qita">
    			</td>
    		</tr>
    		<tr>
    			<td class="as">
    		...
    		<tr>
    			...
    			<td colspan="5">
    				<input type="text" name="remark" style="width:400px"/><input id="showbt" style="width:100px;display:none" type="button" onclick="showpaiban()" value="查看排班计划表"/><br><span id = tip style="color:red"></span><span id = tip1 style="color:red"></span>
    			</td>
    		</tr>
