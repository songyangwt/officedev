 ...
 <!--   <p align="right" style="padding:0px;margin:0px"><strong> 编号：123456789123456</strong></p>-->
  ...
  <table width="800" height="459" border="1" cellpadding="0" cellspacing="0" align="center">
    <tr>
      ...
      <td width="100"><div align="center"><input style="width:90px" type="text" name="name" id="name" value="${name}" onblur="change1()"/></div></td>
    ...
    <tr>
      ...
      <td colspan="7" style="padding-left:10px">
      	<label><input id="1" name="type" type="radio" value="1" onclick="jisuan();alert('1.向下一级审批人出示县级或二级乙等以上医院开具的病休证明、病历原件及复印件  2.请在备注中填写病假情况说明')"/>病假&nbsp;&nbsp;<span class="tip">（请向下一级审批人出示县级或二级乙等以上医院开具的病休证明、病历原件及复印件）</span></label>
      	<br/>
      	<label><input id="13" name="type" type="radio" value="13" onclick="jisuan();"/>陪考假<span class="tip">（请向下一级审批人出示子女中、高考准考证复印件，陪考假3天，其中考前1天，考试2天）</span></label>
      	<br/>
      	<label><input id="2" name="type" type="radio" value="2" onclick="jisuan();change1();"/>年休假<span class="tip">（休假次数不应超过3次，</span> </label>
      	<span class="tip" id="xianshi">本年剩余可休天数：${yearrest}天；剩余可休次数：${yearcishu}次）</span>    
      	<br/>
      	<label><input id="3" name="type" type="radio" value="3" onclick="jisuan();alert('请在备注栏填写请假事由！')"/>事假</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
       	<label><input id="14" name="type" type="radio" value="14" onclick="jisuan();"/>哺乳假</label><span class="tip">（女员工产后上班第一天到小孩满一周岁可申请哺乳假）</span>
      	<br/>
      	<label><input id="4" name="type" type="radio" value="4" onclick="jisuan();alert('1.向下一级审批人和考勤管理员出示结婚证  2.备注请填写结婚日期  3.领证一年内可休婚假')"/>婚假</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      	<label><input id="10" name="type" type="radio" value="10" onclick="jisuan();alert('1.在工作时间内依法参加选举等社会活动可以请公假 2.请在备注栏填写请假事由')"/>公假</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      	<label><input id="11" name="type" type="radio" value="11" onclick="jisuan();change1();"/>加班调休</label>&nbsp;&nbsp;
      	<span class="tip" id="xianshi2">（剩余可休天数：${jbsprestdays}）</span>
      	<br/>
      	<label><input id="9" name="type" type="radio" value="9" onclick="jisuan();"/>工伤假</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      	<label><input id="12" name="type" type="radio" value="12" onclick="jisuan();"/>产检</label><input size="8" type="hidden" id="qita" name="qita" value="产检"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      	<label><input id="5" name="type" type="radio" value="5" onclick="jisuan();"/><input type="hidden" value="${chanrestdays}" id="chanrestdays" name="chanrestdays"/>产假（或陪护假）</label>
      	<br/>
      	<label><input id="8" name="type" type="radio" value="8" onclick="jisuan();alert('仅员工父母、配偶、子女或配偶父母去世可以请丧假')"/>丧假</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      	<label><input id="7" name="type" type="radio" value="7" onclick="jisuan();alert('同父母分居两地，乘坐火车、汽车不能在周末休息日团聚可以请探亲假')"/><input type="hidden" value="${tanfmrestdays}" id="tanfmrestdays" name="tanfmrestdays"/>探亲假（父母）</label>&nbsp;&nbsp;&nbsp;&nbsp;
      	<label><input id="6" name="type" type="radio" value="6" onclick="gjisuan();alert('同配偶分居两地，乘坐火车、汽车不能在周末休息日团聚可以请探亲假')"/><input type="hidden" value="${tanporestdays}" id="tanporestdays" name="tanporestdays"/>探亲假（配偶）</label>
      	<br/>
      <!--  
     ...
     <tr>
      ...
      <td colspan="7" >
     <div style="float:left;padding-top:8px;width:110px">从<input size="9" type="text" name="begindate" value="${begindate}" id="begindate" class="Wdate" onClick="WdatePicker();jisuan();change1();" ></div>
     ...
     <div style="float:left;padding-top:8px;width:120px"> 起至<input size="9" type="text" name="enddate" id="enddate" value="${enddate}" class="Wdate" onClick="WdatePicker();jisuan();checkdate2();" ></div>      
     <div style="float:left">      
    ...
    <tr>
      ...
      <td colspan="7"><input type="text" name="remark" value="${remark}" style="width:400px"/><input id="showbt" style="width:100px;display:none" type="button" onclick="showpaiban()" value="查看排班计划表"/><br><span id = tip style="color:red"></span></td>
      </tr>
     <tr>
      <td align="center">审批人</td>
        ...
        <td>
        	...
        	<input type="hidden" id="begindate1" value="${begindate}"/>
