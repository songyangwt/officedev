 ...
 function expressout()
	{
		...
		window.location = "<%=path%>/exportleave.action?begindate="+begindate+"&enddate="+enddate+"&chutuan="+chutuan+"&applicant="+applicant+"&type="+type+"&status="+status;
	}
 </script>
					...
					<table height="80" align="center" cellpadding="0"
						...
						<tr>
							<td
								...
								colspan="13" align="center" bordercolor="#FFFFFF"><b><c:if test="${authoT=='T'||authoI=='I'||authoJ=='J'||zhi=='0'||zhi=='1'}">中心明细</c:if><c:if test="${zhi=='2'||zhi=='4'}">团队明细</c:if></b>
							</td>
						</tr>
						<tr>
							<td colspan="13" height="10px">
								<div align="center">
									...
									<c:if test="${authoT=='T'||authoI=='I'||authoJ=='J'||zhi=='0'||zhi=='1'}">
									处室团队
									...
									<c:if test="${authoI=='I'||authoJ=='J'||chu=='1'||zhi=='0'||zhi=='1'||zhi=='2'}">
						...
						<tr height="50px" class="表格表头背景1" id="hang">
							...
							<tr class="btbj" id="hang" style="height:20px">
								...
								<td width="140px" height="25" align="center" valign="middle" nowrap><div
										align="center">
										<c:if test="${(authoI=='I')&&(leave.status!=3)}">
							...
							<td colspan="13">
								<div align="center">
								<a	href="<%=path%>/viewall.action?zhuan=1&begindate=${begindate}&enddate=${enddate}&applicant=${strtemp}&zxtd=td&chutuan=${chutuan}&type=${type}&status=${status}&newnumber=${newnumber}&currentPage=${previousPage}"
							style="padding-right: 30px;color: #104E8B">上一页</a> 
									${currentPage} of ${totalPages}
								<a	href="<%=path%>/viewall.action?zhuan=1&begindate=${begindate}&enddate=${enddate}&applicant=${strtemp}&zxtd=td&chutuan=${chutuan}&type=${type}&status=${status}&newnumber=${newnumber}&currentPage=${nextPage}"
