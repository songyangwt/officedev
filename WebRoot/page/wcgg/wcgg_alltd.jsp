...
$('#chutuan').attr('value',x[0].value);
 ...
 function expressout()
	{
		...
		window.location = "<%=path%>/exportwcgg.action?begindate="+begindate+"&enddate="+enddate+"&chutuan="+chutuan+"&applicant="+applicant;
	}
 </script>
 <link href="<%=path%>/css/table_back.css" rel="stylesheet" type="text/css">
  ...
  <body>
  ${daohang}
  <form action="<%=path%>/viewwcggall.action" method="post" name="fm1">
					<table height="80" align="center" cellpadding="0"
						cellspacing="2" border: 0px;">
						<tr>
							<td
								style="color: #1778C2; padding-top: 0px; padding-bottom: 5px; border: 0px; font-size: 26px; font-family: '黑体';"
								colspan="15" align="center" bordercolor="#FFFFFF"><b><c:if test="${authoT=='T'||authoI=='I'||zhi=='0'||zhi=='1'}">中心明细</c:if><c:if test="${zhi=='2'||zhi=='4'}">团队明细</c:if></b>
							</td>
						</tr>
						<tr  >
							<td colspan="26" height="10px">
								<div align="center">
									...
									<c:if test="${authoT=='T'||authoI=='I'||zhi=='0'||zhi=='1'||chu=='1'}">
									处室团队
									...
									<c:if test="${authoI=='I'||zhi=='0'||zhi=='1'||zhi=='2'||chu=='1'}">
						...
						<tr height="50px" class="表格表头背景1" id="hang">
							...
							<tr class="btbj" id="hang" style="height:20px">
								...
								<td width="50px" height="25" align="center" valign="middle" nowrap><div
										align="center">${wcgg.initiator}</div></td>
								...
								<td width="70px" height="25" align="center" valign="middle" nowrap><div
										align="center">${wcgg.baodaodate}</div></td>							
								<td width="40px" height="25" align="center" valign="middle" nowrap><div
										align="center">${wcgg.days}</div></td>
								<td width="50px" height="25" align="center" valign="middle" nowrap><div
										align="center">${wcgg.thisunder}</div></td>
								<td width="70px" height="25" align="center" valign="middle" nowrap><div
										align="center">${fb:newstatustostring(wcgg.status)}</div></td>
								 
								<td width="140px" height="25" align="center" valign="middle" nowrap><div
										align="center">
										<c:if test="${(authoI=='I')&&(wcgg.status!=4)&&(wcgg.status!=6)}">
										<a onClick="return confirm('确定撤销?');"  href="<%=path%>/deletewcggpage.action?number=${wcgg.number}&newnumber=${newnumber}">撤销</a>
										&nbsp;&nbsp;
										</c:if>
							...
							<td colspan="15">
								<div align="center">
								<a	href="<%=path%>/viewwcggall.action?zhuan=1&begindate=${begindate}&enddate=${enddate}&zxtd=td&chutuan=${chutuan}&name=${strtemp}&newnumber=${newnumber}&currentPage=${previousPage}"
							style="padding-right: 30px;color: #104E8B">上一页</a> 
									${currentPage} of ${totalPages}
								<a	href="<%=path%>/viewwcggall.action?zhuan=1&begindate=${begindate}&enddate=${enddate}&zxtd=td&chutuan=${chutuan}&name=${strtemp}&newnumber=${newnumber}&currentPage=${nextPage}"
