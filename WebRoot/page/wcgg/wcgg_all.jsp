 ...
 function expressout()
	{
		...
		window.location = "<%=path%>/exportwcgg.action?begindate="+begindate+"&enddate="+enddate+"&applicant="+applicant;
	}
 </script>
					...
					<table height="80" align="center" cellpadding="0"
						...
						<tr>
							<td
								...
								colspan="15" align="center" bordercolor="#FFFFFF"><b>个人明细</b>
							</td>
						</tr>
						<tr  >
						...
						<tr height="50px" class="表格表头背景1" id="hang">
							...
							<td colspan="15">
								<div align="center">
								<a	href="<%=path%>/viewwcggall.action?zhuan=1&begindate=${begindate}&enddate=${enddate}&chutuan=${chutuan}&name=${strtemp}&newnumber=${newnumber}&currentPage=${previousPage}"
							style="padding-right: 30px;color: #104E8B">上一页</a> 
									${currentPage} of ${totalPages}
								<a	href="<%=path%>/viewwcggall.action?zhuan=1&begindate=${begindate}&enddate=${enddate}&chutuan=${chutuan}&name=${strtemp}&newnumber=${newnumber}&currentPage=${nextPage}"
