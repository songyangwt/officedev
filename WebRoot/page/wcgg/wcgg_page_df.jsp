		...
		if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
			...
			//alert(yesorno);
				...
				if(arr[0].length==5)
				{
					...
					bossname(arr[1]);
					document.getElementById("intchu").value=arr[2];
					document.getElementById("allname").value=arr[3];
					document.getElementById("chuname").value=arr[4];
		}				
	} 
	xmlhttp.open("GET","showwcggpagedfajax.action?name="+name+"&newnumber="+newnumber,true);
	xmlhttp.send();
}
    ...
    <form action="subwcggpage.action" method="post">
        ...
        <table width="860" height="398" border="1" align="center" cellpadding="1" cellspacing="0">
    		...
    		<tr>
    			...
    			<td><input type="button" id="button" value="减少一位同行人" onclick="b()"/></td>
    		</tr>
    		<tr>
    			<td class="as">
    				公干事由<b>*</b>
    		...
    		<tr>
    			...
    			<td colspan="5">
    				...
    				<input type="hidden" id="intchu" name="intchu" value=""/>
