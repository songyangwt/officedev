    ...
    function isworkday()
     {
		...
		if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
			...
			else
			{
				...
				with(document.forms[0]) {
						action="showyscjpagetjdf.action?nameapply="+name1+"&isworkday="+isworkday;
						//alert(name);
						//alert(isworkday);
						method="post";
						submit();
	 ...
	 function tijiao() {
		...
		var enddates=new Date(enddates);	 
		  ...
		  var sumdate=document.getElementById("sumday"); 
		...
		if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
			yesorno=xmlhttp.responseText;
				...
				if(arr[0].length==5)
				{
					...
					bossname(arr[1]);
					document.getElementById("identity").value=arr[2];
					//document.getElementById("username").innerHTML=arr[3]+arr[4];
			
					document.getElementById("zxdate").value=arr[3];
					document.getElementById("age").value=arr[4];
					document.getElementById("sex").value=arr[5];
					
		}				
	} 
	xmlhttp.open("GET","showyscjpagedfajax.action?name="+name+"&newnumber="+newnumber,true);
	xmlhttp.send();
}
...
${daohang}  
    <form action="subyscjpage.action" method="post">
      ...
      <div>&nbsp;&nbsp;&nbsp;&nbsp; <span>申请人：<input type="text" id="name" name="name" onblur="change1()"/> </span>
    				 所在处室：<span align="center" id="chutuan" name="chutuan">&nbsp;</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    				
             <span>   职务<b>*</b>：<select id="zhiwu" name="zhiwu" style="padding:0px;margin:0px;">
    		...
    		<tr>
    	       ...
    	       <td width="72" class="as">
    			...
    			<td width="201" class="as" >
    				<input type="text" id="identity" name="identity" readonly="readonly"/> 
    			</td>
    			<td width="141" class="as" >
    				户口所在地<b>*</b>
    			</td>
    			<td width="121" class="as" >
    			...
    			<td colspan="2" rowspan="2">
    				<input type="text" id="zxdate" name="zxdate" readonly="readonly"/> 
    			</td>
    	   ...
    	   <tr>
    		...
    		<tr>
    			...
    			<input size="9" type="text" name="begindate" id="begindate" class="Wdate" onClick="WdatePicker()" onchange="isworkday()"><br>
     			  下班前<input id="afterwork1" name="afterwork" type="radio" value="0" onClick="isworkday()"> 下班后<input id="afterwork2" name="afterwork" type="radio" value="1" onClick="isworkday()" >		
    			</td>
    			<td class="as">
    				拟回国（境）时间<b>*</b>
    			</td>
    			...
    			<input size="9" type="text" name="enddate" id="enddate" class="Wdate" onClick="WdatePicker()" onchange="isworkday()"><br>
     			 上班前<input id="beforework1" name="beforework" type="radio" value="0" onClick="isworkday()"> 上班后<input id="beforework2" name="beforework" type="radio" value="1" onClick="isworkday()" >	 
    			</td>
    		</tr>
    		<tr>
    		     <td class="as">
