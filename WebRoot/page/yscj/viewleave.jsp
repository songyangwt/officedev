...
function tijiao()
{
	var leavelist = document.getElementsByName("leavechoose");
 ...
 <link href="<%=path%>/css/table_back.css" rel="stylesheet" type="text/css">
  ...
  <body>
  ${daohang}
  <form action="<%=path%>/viewleave.action" method="post" name="fm1">
						...
						<tr height="50px" class="表格表头背景1" id="hang">
							...
							<tr class="btbj" id="hang" style="height:20px">
								...
								<td width="140px" height="25" align="center" valign="middle" nowrap><div
										align="center">
										<input id="${leave.number}" type="checkbox"  name="leavechoose" value="${leave.number}"  />
							...
							<td colspan="13">
								...
								<input type="hidden" name="newnumberapply" value="${list[0].applicant}"/>
