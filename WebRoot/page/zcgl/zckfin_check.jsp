...
function tijiao()
 ...
 <!-- <link href="<%=path%>/css/table_back.css" rel="stylesheet" type="text/css"> -->
  ...
  <body>
  ${daohang}
  <form action="<%=path%>/zckfinshenpi.action" method="post" name="fm1">
				<br>
					<br>	
					 <p align="center" style="padding:0px;margin:0px; font-size: 24px;"><strong>业务处理中心资产入库复核表</strong><strong> </strong></p>
