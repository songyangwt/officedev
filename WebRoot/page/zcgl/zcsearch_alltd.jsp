  ...
  <form action="<%=path%>/viewzcsearchallzx.action" method="post" name="fm1">
					...
					<table height="80" align="center" cellpadding="0"
						...
						<tr height="50px" class="表格表头背景1" id="hang">
							...
							<td colspan="15">
								<div align="center">
								<a	href="<%=path%>/viewzcsearchallzx.action?zhuan=1&assetchu=${assetchu}&assetname=${assetname}&assettype=${assettype}&newnumber=${newnumber}&currentPage=${previousPage}"
							style="padding-right: 30px;color: #104E8B">上一页</a> 
									${currentPage} of ${totalPages}
								<a	href="<%=path%>/viewzcsearchallzx.action?zhuan=1&assetchu=${assetchu}&assetname=${assetname}&assettype=${assettype}&newnumber=${newnumber}&currentPage=${nextPage}"
