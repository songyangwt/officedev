...
<body>
	<div style="color: #1778C2; padding-top: 0px; padding-bottom: 5px; border: 0px; font-size: 26px; font-family: '黑体';"
			colspan="14" align="center" bordercolor="#FFFFFF"><b>资产存放位置和使用人批量修改</b>
	</div>
	<div class="layout">
		<form name="filename" method="post" action="importchangeinfowai.action"
			enctype="multipart/form-data">
			<div class="title" ><b>修改信息表导入,选择上传文件</b></div>
			<div id="content" >
				<div class="four_columns">
					...
					<div class="four_columns_input">
					   ...
					   <input type="hidden" name="authoS" value="${authoS}"/>
						 <input type="submit" name="submit" value="上传">
					</div>
						<br/>
					<div class="four_columns_input" >
						<a href="<%=path%>/templet/zcxg.xls">下载【资产存放位置和使用人批量修改信息表】模板</a>
					</div>
				</div>
			</div>
		</form>
