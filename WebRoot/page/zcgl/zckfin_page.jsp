...
<html>
  <head>
	...
	function show(name,type,number)
	{
		...
		var numberc = number;
		window.location = "<%=path%>/showkfin.action?name="+namec+"&type="+typec+"&number="+number;
	}
	function upload()
	{
		with(document.forms[0]) {
			action='importzckfin.action';
			method="post";
			submit();
			}
	}
 ...
 ${daohang}  
    <form name="myform" method="post" enctype="multipart/form-data">
    	<br>
    		<br>	
    	 <p align="center" style="padding:0px;margin:0px; font-size: 24px;"><strong>业务处理中心资产入库表</strong><strong> </strong></p>
        <table id="mytable"  border="1" align="center" cellpadding="1" cellspacing="0">
    		<tr height="50">
    		 <td width="100" class="as" >
    			...
    			<td width="500" colspan="3">
    			      <a href="<%=path%>/templet/zcruku.xls">下载【资产入库表】模板</a><br/>
    		...
    		<tr height="40">
    			...
    			<td colspan="7" >
    				<input type="text" style="width:700px" name="remark" id="remark" />
    				&nbsp;&nbsp;
    			</td>
    		</tr>
