...
<html>
  <head>
	...
	<script type="text/javascript">
	 ...
	 function tijiao() {
	      ...
	      var message = "您填写的使用人是"+people+"确认提交？";
		  if (window.confirm(message)) {
		       with(document.forms[0]) {
						
						action='subchangepeoplepage.action';
						method="post";
						submit();
					}
				}
  ...
  <body> 
 ${daohang} 
    <form action="subchangepeoplepage.action" method="post">
    	<br>
    		<br>	
        ...
        <table id="mytable"  border="1" align="center" cellpadding="1" cellspacing="0">
    		...
    		<tr height="50">
    			...
    			<td  width="200" class="as" >
    				 <input type="text" id="people" name="people"  value="${assetinfo.people}"/>
